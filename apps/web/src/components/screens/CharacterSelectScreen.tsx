                ...
                >
                  <div className="bg-bg-elevated h-20 w-20 overflow-hidden rounded-lg">
                    {c.icon ? (
                      ...
                      <div className="font-display flex h-full w-full items-center justify-center bg-gradient-to-br from-[var(--color-accent-strong)]/40 to-[var(--color-panel)] text-3xl font-bold text-white/80">
                        {c.config.name.charAt(0).toUpperCase()}
                      </div>
                    )}
                  </div>
